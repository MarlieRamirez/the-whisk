    ...
    <div class="flex min-h-screen flex-col items-center bg-[#faf5ef] p-6 text-[#1b1b18] dark:bg-[#0a0a0a] lg:justify-center lg:p-8">
        ...
        <div class="duration-750 starting:opacity-0 flex w-full items-center justify-center opacity-100 transition-opacity lg:grow">
            <main class="flex w-full max-w-[335px] flex-col-reverse overflow-hidden rounded-lg lg:max-w-4xl lg:flex-row">
                ...
                >
                    <h1 class="mb-1 font-bold text-xl">Inventario The Whisk</h1>
                    <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">
                        Aplicación para Inventario y saldo general de mini empresa. The Whisk<br />
                        Para empezar inicie sesión
                        <br><br>
                    </p>
